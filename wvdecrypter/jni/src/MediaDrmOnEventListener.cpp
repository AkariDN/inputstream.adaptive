...
CJNIMediaDrmOnEventListener::CJNIMediaDrmOnEventListener(const std::string &dexPath)
  : CJNIBase(s_className)
{
  jhclass clazz = CJNIClassLoader(dexPath).loadClass(GetDotClassName(s_className));

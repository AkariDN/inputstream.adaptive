...
namespace SSD
{
  ...
  public:
    ...
    virtual AP4_CencSingleSampleDecrypter *CreateSingleSampleDecrypter(const AP4_DataBuffer &pssh, const char *optionalKeyParameter, const uint8_t *defaultkeyid) = 0;

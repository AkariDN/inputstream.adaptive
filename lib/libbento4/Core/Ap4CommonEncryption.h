...
public:
    ...
    virtual AP4_Result SetFragmentInfo(AP4_UI32 poolid, const AP4_UI08* keyid, const AP4_UI08 nalu_length_size,
      const AP4_DataBuffer &annexb_sps_pps, AP4_UI32 flags) { return AP4_ERROR_NOT_SUPPORTED; };
    virtual AP4_UI32 AddPool(const AP4_UI08* keyid, const AP4_DataBuffer &pssh) { return 0; };
...
public:
    ...
    virtual AP4_Result DecryptSampleData(AP4_UI32 poolid, AP4_DataBuffer& data_in,
      AP4_DataBuffer& data_out,
      const AP4_UI08* iv);
protected:
